...
//        List<String> lists = Arrays.asList("a","b","c","d","e","f","0","","","2","");
//        List<String> list1 = lists.stream().filter(i -> !i.isEmpty()).collect(Collectors.toList());
//        System.out.println(list1);
//        String list2 = lists.stream().filter(i -> !i.isEmpty()).collect(Collectors.joining(","));
